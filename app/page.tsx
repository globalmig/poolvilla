    ...
    <main>
      ...
      <section className="py-28 px-8">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            <span className="inline-flex items-center rounded-full bg-[#2A8EA2]/10 px-3.5 py-1.5 text-xs font-semibold text-[#1E7A8D] mb-5">
              About
            </span>
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-gray-900 mb-1 leading-snug">
              충청남도 보령,
            </h2>
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-gray-900 mb-8 leading-snug">
              원산도의 프라이빗 풀빌라
            </h2>
            <p className="text-base text-gray-500 leading-loose mb-3">
              서해의 아름다운 섬 원산도에 위치한 프리미엄 풀빌라입니다.
              각 객실마다 독립적인 수영장과 스파, 사우나를 갖추고 있어
              완벽한 프라이버시와 함께 최고의 휴식을 선사합니다.
            </p>
            <p className="text-base text-gray-500 leading-loose mb-10">
              실내 온수 수영장과 전용 스파, 온열 사우나까지 —
              토탈 힐링 스페이스에서 특별한 추억을 만들어 보세요.
            </p>
            <Link
              href="/guide"
              className="btn-pop inline-flex items-center gap-2 text-sm font-semibold rounded-full px-6 py-3 bg-gray-900 text-white hover:bg-gray-800 transition-colors"
            >
              이용안내 보기 →
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {roomTypes.map((room) => (
              <Link
                ...
                className="btn-pop group block bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-shadow duration-500"
              >
      ...
      <section className="relative overflow-hidden mx-4 md:mx-8 rounded-3xl" style={{ height: "60vh" }}>
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-white text-center px-8">
          <span className="inline-flex items-center rounded-full bg-white/15 backdrop-blur-sm px-4 py-1.5 text-sm font-semibold mb-6 text-white/90">
          ...
          <Link
            href="/booking"
            className="btn-pop text-sm font-semibold rounded-full px-8 py-3.5 bg-[#2A8EA2] text-white shadow-lg transition-colors duration-300"
          >
            지금 예약하기
          </Link>
        </div>
