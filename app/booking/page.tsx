  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden" style={{ height: "40vh" }}>
        <Image
          src="/스파풀(A,B,C공통)/KakaoTalk_20260702_113804103_03.jpg"
          alt="실시간예약"
          fill
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto text-center mb-10">
          ...
          <p className="text-gray-500 text-sm">
            원하시는 객실을 먼저 선택한 후, 체크인·체크아웃 날짜를 골라주세요.
          </p>
        </div>
        <BookingCalendar />
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            <div className="rounded-3xl bg-[#1C2B3A] text-white p-8 text-center shadow-sm">
              <div className="text-3xl mb-4 flex justify-center"><FiPhone /></div>
              ...
              <a
                ...
                className="btn-pop inline-block rounded-full px-6 py-2.5 bg-[#2A8EA2] text-white text-sm font-semibold shadow-sm hover:shadow-lg transition-shadow"
              >
                전화하기
              </a>
            </div>
            ...
            <div className="rounded-3xl bg-[#FAFAF9] p-8 text-center shadow-sm">
              <div className="text-3xl mb-4 flex justify-center"><FiMessageCircle /></div>
            ...
            <div className="rounded-3xl bg-[#FAFAF9] p-8 text-center shadow-sm">
              <div className="text-3xl mb-4 flex justify-center"><FiMapPin /></div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto rounded-3xl bg-[#FAFAF9] p-8">
          ...
          <ul className="space-y-2.5 text-sm text-gray-600">
            {[
              "예약금(총 금액의 30%) 입금 후 예약이 확정됩니다.",
              "잔금은 체크인 당일 현장 결제 또는 사전 계좌이체로 납부해 주세요.",
              "성수기 및 연휴 기간에는 별도 요금이 적용될 수 있습니다.",
            ].map((t) => (
