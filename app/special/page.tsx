...
const SAUNA_IMGS = [1, 2, 3, 4, 5, 6, 7].map(
  (i) => `/${SAUNA_BASE}_${String(i).padStart(2, "0")}.jpg`
);
const GRILL_IMGS = ["/grill.jpg", "/grill02.jpg"];
const OUTDOOR_BBQ_IMGS: string[] = [];
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              {fac.images.length > 0 ? (
                ...
                <div className="h-full w-full flex items-center justify-center bg-[#FAFAF9] text-gray-400 text-sm font-medium">
                  사진 준비중
                </div>
              )}
            </div>
